/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 020714209be198ed108aeb9d3a7b9abd)
...
declare namespace Cloudflare {
	interface Env {
		...
		SESSIONS: DurableObjectNamespace<import("./src/index").VttSessions>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "PORT" | "NODE_ENV" | "GOOGLE_CLIENT_ID" | "GOOGLE_CLIENT_SECRET">> {}
}
