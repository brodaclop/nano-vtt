...
let ctx: OffscreenCanvasRenderingContext2D = fogCanvas.getContext('2d', { willReadFrequently: true })!;


export const drawFog = (fog: Array<FogCircle>, size: Point) => {
...
export const isScreenPointInFog = (p: Point): boolean => {
    const imageData = ctx.getImageData(p.x, p.y, 1, 1);
    console.log('imageData', p, imageData.data);
